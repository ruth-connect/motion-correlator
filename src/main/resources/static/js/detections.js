...
function getVideo(detection) {
	return detection.videoPath ? "<button class=\"button large mdi mdi-video\" type=\"button\" style=\"margin-bottom: 0px;\" onclick=\"jQuery.facebox('<div style=\\\'width: 640px; height: 480px;\\\'><video width=\\\'640\\\' height=\\\'480\\\' controls autoplay><source type=\\\'video/mp4\\\' src=\\\'" + detection.videoPath + "\\\'></video></div>'); return false;\"></button>" : "";
}
...
function displayDetectionRow(detection, prefix, id, processTime, replaced) {
	return	"<tr id=\"" + prefix + "-tr-" + id + "\"" + (processTime ? " data-process-time=\"" + processTime + "\"" : "") + (replaced ? " data-replaced" : "") + ">" +
				"<td>" +
					"<button class=\"button large mdi mdi-information\" type=\"button\" data-toggle=\"" + prefix + "-div-" + id + "\" style=\"margin-bottom: 0px;\"></button>" +
